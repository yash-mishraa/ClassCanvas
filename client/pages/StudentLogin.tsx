...
export default function StudentLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const endpoint = isSignUp ? "/api/auth/student/signup" : "/api/auth/student/login";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-4">
      ...
      >
        <div className="bg-slate-800/50 backdrop-blur border border-cyan-500/20 rounded-2xl p-8 shadow-2xl">
          {/* Logo */}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-2 bg-cyan-500 hover:bg-cyan-600 disabled:bg-slate-600 text-slate-950 font-semibold rounded-lg transition-colors shadow-lg shadow-cyan-500/30"
            >
